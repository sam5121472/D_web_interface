// ============================================
  ...
  // fallback so a Shilajit page can also surface Sea Buckthorn, and vice
  // versa, to encourage larger baskets). It is NOT a live call to any
  // Claude model — a static file has nowhere secure to hold an API key,
  // and calling a real LLM per click would also add cost/latency for
  // something this rule-based matching already does well. The loading
  ...
  function renderReviews(productId){
    ...
    if (reviews.length === 0){
      list.innerHTML = `<div class="review-row"><p class="review-comment">No reviews yet — be the first to share your experience with this product.</p></div>`;
    } else {
